(function(module, exports) {
	...
	exports.loop = function(x, options, fn) {
      if(!fn) {
        fn = options;
        options = {};
      }
      ...
      if(typeof x === 'object') {
        ...
        for (var i in x) {
          ...
          if (arr && !opt.last && options.next) {
            opt.next = x[parseInt(i)+1];
          }
          
          fn(arr ? parseInt(i) : i, x[i], opt);
          index = index + 1;
        }
    ...
    for(var i = 0; i < x; i++) {
      var opt = {last: i == x-1, first: i == 0};
      
      if(!opt.last && options.next) {
        opt.next = x + 1;
      }      
	...
	exports.biggest = function() {
      var big;

      for(var i = 0; i < arguments.length; i++) {
        if(!i || arguments[i] > big) big = arguments[i];
      }
      
      return big;
	};

	exports.lowest = function() {
      var low;
		
      for(var i = 0; i < arguments.length; i++) {
        if(!i || low > arguments[i]) low = arguments[i];
      }
